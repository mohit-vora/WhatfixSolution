...
public class RunForProblemOne {
	...
	public static void main(String[] args) {
		...
		do {
			// Input for weather
			System.out.print("Input: Weather is ");
			 ...
			 */
			List<List<whatfix.beans.Orbit>> availableOrbits = trafficFinder.getLengaburuTrafficHelper()
			...
			for (String orbitName : availableOrbitNames) {
				System.out.print("Input: "+ orbitName +"traffic speed is ");
